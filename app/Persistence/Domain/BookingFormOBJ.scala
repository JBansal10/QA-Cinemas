...
object BookingFormOBJ {
  ...
  case class Booking(id: Int, mID: Int, screenDate: String, cName: String, nSeats: Int, adults: Int, childs: Int, concession: String)
  ...
  case class Bookings(tag: Tag) extends Table[Booking] (tag, "booking") {
    ...
    def screenDateTime = column[String]("SCREEN_DATETIME")
    ...
    def * = (id, mID, screenDateTime, cName, nSeats, adults, childs, concession) <> (Booking.tupled, Booking.unapply)
  }
